...
/* ── MOBILE NAV — i tasti sono sempre registrati, il CSS li mostra solo su ≤768px ── */
function initMobileNav(){
  ...
  // Mostra ‹ › solo quando la card oraria è a schermo
  ...
  // Nascondi nav quando lo sheet del giorno è aperto
  new MutationObserver(()=>{
    const open=$('day-sheet').classList.contains('open');
    $('mobile-nav').style.opacity=open?'0':'1';
    $('mobile-nav').style.pointerEvents=open?'none':'';
